try:
    # Modifica incompatibile introdotta in Python 3.11.
    from enum import StrEnum
except ImportError:  # pragma: no cover  # Esclude questo ramo dalla copertura dei test.
    from enum import Enum  # pragma: no cover  # Esclude questo ramo dalla copertura dei test.

    class StrEnum(str, Enum):  # pragma: no cover  # Compatibilita' per Python precedenti alla 3.11.
        pass  # pragma: no cover  # Classe segnaposto esclusa dalla copertura dei test.
...
class ConfigurationKey(StrEnum):
    ...
    # 9.2 Profilo di gestione della lista di autorizzazione locale
    ...
    # 9.3 Profilo di prenotazione
    reserve_connector_zero_supported = "ReserveConnectorZeroSupported"

    # 9.4 Profilo di ricarica intelligente
    ...
    # OCPP 1.6 ISO 15118 v10 ha aggiunto chiavi di configurazione.
    ...
    # Il white paper OCPP sulla sicurezza ha aggiunto chiavi di configurazione.
...
class FirmwareStatus(StrEnum):
    ...
    # Comune a:
    # FirmwareStatusNotification.req e SignedFirmwareStatusNotification.req
    ...
    # Solo per SignedFirmwareStatusNotification.req
...
class MessageTrigger(StrEnum):
    ...
    # Comune a TriggerMessage.req e ExtendedTriggerMessage.req
    boot_notification = "BootNotification"
    firmware_status_notification = "FirmwareStatusNotification"
    heartbeat = "Heartbeat"
    meter_values = "MeterValues"
    ...
    # Solo per TriggerMessage.req
    diagnostics_status_notification = "DiagnosticsStatusNotification"

    # Solo per ExtendedTriggerMessage.req
    log_status_notification = "LogStatusNotification"
